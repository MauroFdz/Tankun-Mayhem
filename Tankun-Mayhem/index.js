...
function create ()
{
    ...
    player1 = this.physics.add.sprite(100, 450, 'tank1');
    ...
    score2Text = this.add.text(500, 16, 'score: 0', { fontSize: '32px', fill: '#000' });
    ...
    this.physics.add.collider(bullets1, platforms,hitWall, null, this);
    this.physics.add.collider(bullets2, platforms,hitWall, null, this);
